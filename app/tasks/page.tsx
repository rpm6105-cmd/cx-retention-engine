          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Manage customer actions and follow-ups
              </p>
            </div>
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-2">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm font-semibold text-gray-900 shadow-sm outline-none focus:border-gray-300 focus:outline-none focus:ring-4 focus:ring-indigo-600/15 sm:w-52"
                  >
...
function ToggleButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`rounded-lg px-3 py-2 text-sm font-semibold transition focus:outline-none focus:ring-4 focus:ring-indigo-600/15 ${
        active ? "bg-indigo-600 text-white shadow-sm shadow-indigo-600/20" : "text-gray-700 hover:bg-gray-50"
      }`}
      aria-pressed={active}
    >
      {label}
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm shadow-gray-900/5 sm:p-5">
      <div className="flex items-center justify-between">
        ...
        <div className="rounded-full bg-gray-100 px-2 py-1 text-xs font-semibold text-gray-700 ring-1 ring-inset ring-gray-200">
          {tasks.length}
        </div>
      </div>
      ...
      <div className="mt-4 space-y-3">
        {tasks.map((t) => (
          <div
            key={t.id}
            className="cursor-pointer rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition hover:shadow-md hover:shadow-gray-900/10"
            onClick={() => onSelect(t)}
          >
...
function CreateTaskModal({
  ...
  const customers = [
    { id: "CUST-1024", name: "Acme Co" },
    { id: "CUST-1025", name: "Northwind" },
    { id: "CUST-1027", name: "Initech" },
    { id: "CUST-1029", name: "Wayne Enterprises" },
  ];
      ...
      <div className="w-full max-w-lg rounded-2xl border border-gray-200 bg-white shadow-lg shadow-gray-900/15">
        <div className="flex items-start justify-between gap-3 border-b border-gray-200 p-4 sm:p-5">
          <div>
            ...
            <div className="mt-0.5 text-xs text-gray-600">Mock modal (local state only)</div>
          </div>
          <button
            className="grid h-9 w-9 place-items-center rounded-xl text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-900/10"
            onClick={onClose}
            aria-label="Close"
          >
        ...
        <div className="space-y-4 p-4 sm:p-5">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={4}
              className="w-full resize-none rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm font-semibold text-gray-900 shadow-sm outline-none placeholder:text-gray-400 focus:border-gray-300 focus:outline-none focus:ring-4 focus:ring-indigo-600/15"
            />
          </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-3 text-sm text-gray-700">
            <span className="font-semibold">Preview:</span> {title || "Untitled"} ·{" "}
            {customerName} · Due {dueDate}
          </div>
        </div>
        ...
        <div className="space-y-4 p-4 sm:p-5">
          <div>
            ...
            <div className="mt-1 text-sm text-gray-700">
              {task.description?.trim().length ? task.description : "No description provided."}
            </div>
          </div>
