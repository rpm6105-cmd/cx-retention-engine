...
export default function ProfilePage() {
  ...
  async function handleUpdateName(e: React.FormEvent) {
    ...
    if (error) { setNameError("Failed to update name."); return; }
            ...
            {plan === "Starter" && (
              <div className="mt-4 rounded-2xl border border-indigo-100 bg-indigo-50 p-4">
                <div className="flex items-start gap-3">
                  <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-indigo-600 text-white shadow-sm shadow-indigo-600/20">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-xs text-indigo-700">
                      Unlock AI Copilot, CSV exports, and advanced health scoring. Contact your admin to upgrade.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <Card>
          ...
          <CardBody>
            <form onSubmit={handleUpdateName} className="space-y-4">
              ...
              {nameError && (
                <div className="rounded-xl border border-rose-200 bg-rose-50 px-3 py-2.5 text-xs font-semibold text-rose-700">{nameError}</div>
              )}
              {nameSuccess && (
                <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2.5 text-xs font-semibold text-emerald-700">Name updated successfully.</div>
              )}
        ...
        <Card>
          ...
          <CardBody>
            <form onSubmit={handleUpdatePassword} className="space-y-4">
              ...
              {pwError && (
                <div className="rounded-xl border border-rose-200 bg-rose-50 px-3 py-2.5 text-xs font-semibold text-rose-700">{pwError}</div>
              )}
              {pwSuccess && (
                <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2.5 text-xs font-semibold text-emerald-700">Password updated successfully.</div>
              )}
